...
--
-- Host: 127.0.0.1
-- Tempo de geração: 05-Set-2022 às 14:36
...
INSERT INTO `os` (`num_os`, `mat_func`, `cpf_cliente`, `plac_veiculo`, `km_retirada`, `km_devolução`, `data_devolução`, `data_retirada`, `status`, `valor_total`) VALUES
(1, 1001, 123456780, 'AWV1234', '1800.59', '2010.89', '2021-01-03', '2021-01-05', 1, '0.00'),
(2, 1011, 123456798, 'Awv1323', '10000.00', '15000.00', '2021-01-03', '2021-01-19', 1, '0.00'),
(3, 1009, 123456799, 'Adx1473', '8528.00', '9002.00', '2021-01-10', '2021-01-20', 1, '0.00'),
(4, 1006, 123456789, 'Aqw1234', '10000.00', '12345.00', '2021-01-10', '2021-01-20', 1, '0.00'),
(5, 1012, 123549800, 'AZX3273', '34580.00', '39508.00', '2021-02-02', '2021-02-10', 1, '0.00'),
(6, 1001, 129778946, 'ABW4007', '60050.00', '63083.00', '2021-02-05', '2021-02-15', 1, '0.00'),
(7, 1006, 129345678, 'AWS2365', '4058.23', '4555.55', '2021-02-06', '2021-02-10', 1, '0.00'),
(8, 1012, 128799480, 'AQX3451', '60038.00', '6200.15', '2021-01-01', '2021-01-08', 1, '0.00'),
(9, 1012, 123764598, 'ADE3456', '12058.00', '19000.00', '2021-01-01', '2021-01-10', 1, '0.00'),
(10, 1013, 123456781, 'ACZ3243', '10000.00', '13580.00', '2021-05-01', '2021-05-05', 1, '0.00'),
(11, 1001, 123456780, 'ABW4007', '3500.00', '3900.00', '0000-00-00', '0000-00-00', 1, '0.00');
...
--
-- Extraindo dados da tabela `os2022`
--

INSERT INTO `os2022` (`num_os`, `mat_func`, `cpf_cliente`, `plac_veiculo`, `km_retirada`, `km_devolução`, `data_devolução`, `data_retirada`, `status`, `valor_total`) VALUES
(1, 1001, 123456780, 'AWV1234', '1800.59', '2010.89', '0000-00-00', '2021-01-05', 1, '0.00'),
(2, 1011, 123456798, 'Awv1323', '10000.00', '15000.00', '0000-00-00', '2021-01-19', 1, '0.00'),
(3, 1009, 123456799, 'Adx1473', '8528.00', '9002.00', '0000-00-00', '2021-01-20', 1, '0.00'),
(4, 1006, 123456789, 'Aqw1234', '10000.00', '12345.00', '0000-00-00', '2021-01-20', 1, '0.00'),
(5, 1012, 123549800, 'AZX3273', '34580.00', '39508.00', '0000-00-00', '2021-02-10', 1, '0.00'),
(6, 1001, 129778946, 'ABW4007', '60050.00', '63083.00', '0000-00-00', '2021-02-15', 1, '0.00'),
(7, 1006, 129345678, 'AWS2365', '4058.23', '4555.55', '0000-00-00', '2021-02-10', 1, '0.00'),
(8, 1012, 128799480, 'AQX3451', '60038.00', '6200.15', '0000-00-00', '2021-01-08', 1, '0.00'),
(9, 1012, 123764598, 'ADE3456', '12058.00', '19000.00', '0000-00-00', '2021-01-10', 1, '0.00'),
(10, 1013, 123456781, 'ACZ3243', '10000.00', '13580.00', '0000-00-00', '2021-05-05', 1, '0.00'),
(11, 1001, 123456780, 'ABW4007', '3500.00', '3900.00', '0000-00-00', '0000-00-00', 1, '0.00');
...
--
DELIMITER $$
CREATE TRIGGER `tr_valorfinal` AFTER UPDATE ON `os2022` FOR EACH ROW UPDATE os2022 SET valor_total = (data_retirada - data_devolução) * valor_km.categoria
WHERE valor_km.categoria = NEW.valor_total
$$
DELIMITER ;
